...
async function insertAllRealData() {
  try {
    console.log('🚀 Starting Complete Real Data Insertion...');
    ...
    if (orgError || !orgs || orgs.length === 0) {
      ...
      console.log('📋 Please run the complete-schema.sql script in Supabase SQL Editor first!');
      return;
    }
    const org = orgs[0];
    ...
    // Final summary
    console.log('\n🎉 Complete Real Data Insertion Finished!');
    console.log('📊 Summary:');
...
module.exports = { insertAllRealData };
