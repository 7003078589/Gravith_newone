...
async function importWorkProgressData() {
  ...
  console.log('⚠️  Please make sure the work_progress table exists in Supabase first!');
  console.log('   Run the SQL from work-progress-schema.sql in Supabase SQL Editor');
