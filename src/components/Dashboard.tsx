...
export function Dashboard({ onNavigate }: DashboardProps) {
  ...
  const quickStats = {
    activeSites: 1, // We have 1 site (Gudibande)
    totalVehicles: 123, // From your database
    materialValue: realData.totalPurchaseValue,
    monthlyExpenses: realData.totalExpenseAmount,
    activeVendors: 3, // From your database
    completionRate: 78, // Mock for now
  };

  const { recentActivities, alerts, activeSites, quickActions } = dashboardData;
